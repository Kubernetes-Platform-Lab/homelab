...
| Alternatives | <li>Flux - accepted: we have also implemented flux for internal k8s apps essential to build production apps; this is because we wanted to have an experience in both those tools</li>|
| Pros & Cons | **Pros**<ul><li>Centralized k8s production apps management</li><li>Fast and readable web UI</li><li> Good documentation and tons of user information in the internet about ArgoCD</li></ul> |
