...
| Alternatives | <li>ArgoCD (accepted: we have already implemented ArgoCD for our production apps and use it very frequently)</li> |
| Pros & Cons | **Pros**<ul><li>Centralized k8s production apps management</li><li>Very robust CLI</li><li>Good documentation and tons of user information in the internet about it</li></ul>**Cons**<ul><li>(Not a bit deal but still) No native web UI</li></ul>|
